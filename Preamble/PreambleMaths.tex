...
\newcommand{\pltwo}[2]{\ltwo{#1}{#2}}						% L^2(domain, measure) periodic space
...
\newcommand{\lcompMes}{\lambda_2^{jk}}	% 2D composite Leb + sing measure
\newcommand{\ccompMes}{\lambda_2^{\dddmes}}			% 2D composite Leb + sing + point mass measure
...
\newcommand{\ocurl}[1]{\mathrm{curl}_{#1}^{(0)}}	 			% curl with 0 superscript and measure subscript #1
...
\newcommand{\ktdiv}[1]{\mathrm{div}_{#1}^{\kt}}				% k,theta-div with measure subscript #1
