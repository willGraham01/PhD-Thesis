...
\newcommand{\gradgradSob}[2]{H^2_\mathrm{grad}\bracs{#1, \mathrm{d}#2}} %H^2, only really used for Leb. measure
\newcommand{\htwo}[1]{H^2_\mathrm{grad}\bracs{#1}}				% H^2, but without measure tag
