...
\begin{tikzpicture}
	...
	\begin{scope}[shift={(0,0)}]
		...
		\foreach \y in {0,2,...,8} {
			...
			\foreach \x in {0,...,\z} {
				\hexagon{\coreSize}{(\x*\coreSep, \y*\coreSepHeight)}{}{\hexFill}
				\hexagon{\coreSize}{(-\x*\coreSep, \y*\coreSepHeight)}{}{\hexFill}	
				\hexagon{\coreSize}{(\x*\coreSep, -\y*\coreSepHeight)}{}{\hexFill}
				\hexagon{\coreSize}{(-\x*\coreSep, -\y*\coreSepHeight)}{}{\hexFill}
			}
		...
		\foreach \y in {1,3,...,9} {
			\pgfmathsetmacro{\z}{9-0.5*\y}
			\foreach \x in {0,1,...,\z} {
				\hexagon{\coreSize}{(\x*\coreSep + 0.5*\coreSep, \y*\coreSepHeight)}{}{\hexFill}
				\hexagon{\coreSize}{(-\x*\coreSep - 0.5*\coreSep, \y*\coreSepHeight)}{}{\hexFill}	
				\hexagon{\coreSize}{(\x*\coreSep + 0.5*\coreSep, -\y*\coreSepHeight)}{}{\hexFill}
				\hexagon{\coreSize}{(-\x*\coreSep - 0.5*\coreSep, -\y*\coreSepHeight)}{}{\hexFill}
			}
		...
		\hexagon{0.75\hexSize}{(0,0)}{\coreFill}{\coreFill}
	\end{scope}
