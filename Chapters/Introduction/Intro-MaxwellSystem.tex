...
This distinction is often not highlighted (or even acknowledged) in the mathematical literature \tstk{notable exceptions including K-Serena, and their reference?}.
...
\end{align*}
The benefits of this process are that all possible behaviours of the Maxwell system are characterised by the values these three parameters take, and the (non-dimensional) spectrum is qualitatively representative of the physical frequencies, and can be obtained via the transform $z = \frac{\omega}{\omega_{\mathrm{bulk}}} \frac{l}{\lambda_{\mathrm{bulk}}}$.
It is therefore natural to consider the various asymptotic limits of these free parameters and the resulting asymptotic problems.
...
Such studies lean heavily on the theory of homogenisation, which we discuss in \tstk{lit review section}.
