...
Additional results about the density of states were also proven, the main takeaway being that the spectrum concentrates near the right-endpoints of the bands as $\sigma$ increases. \tstk{Friedlander 2002 proves these same results (even referencing HL) but using a different method involving DtN maps, and under slightly stricter assumptions on the boundary of the domain; Selden on the asymptotics of the integrated DoS, etc}
...
In terms of addressing the scattering problem, \tstk{need to address this too...!}

\tstk{now, why did we bother talking about any of this in the first place?}
