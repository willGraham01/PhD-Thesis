...
As we have already mentioned in our reviews in sections \ref{ssec:Intro-ThinStructures}, \tstk{other previous sections of lit review}, our interest lies in studying problems involving so-called singular structures, akin to the visual ``limits" discussed in the aforementioned sections.
