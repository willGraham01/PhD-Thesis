...
More precisely, the operator $\mathcal{G}$ acts in an \emph{exteneded} (or ``larger") Hilbert space $\mathcal{H}^+$, rather than a ``standard" space $\mathcal{H}\subset\mathcal{H}^+$ containing functions on metric graphs.
