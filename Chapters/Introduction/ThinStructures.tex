...
\end{align*}
the resulting setup illustrated in figure \ref{fig:Diagram_ScalingDimensionfull}.
We now wish to treat the system of Maxwell equations mathematically, and so proceed to write the equations in a dimensionless way by first introducing the dimensionless fields
...
\begin{figure}[t]
	...
	\begin{subfigure}[t]{0.3\textwidth}
		\centering
		\includegraphics[scale=1.0]{Diagram_ScalingDimensionfull.pdf}
		\caption{\label{fig:Diagram_ScalingDimensionless} Schematic illustration of the period cell of a composite, periodic medium, prior to non-dimensionalisation.}
	\end{subfigure}
\end{figure}
