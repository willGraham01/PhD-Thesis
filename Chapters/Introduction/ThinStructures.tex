\section{Wave Propagation in Periodic Media} \label{sec:MathIntro}
...
Wave propagation in electromagnetism is governed by the system of Maxwell equations; \tstk{fields bold here, so later can use non-bold E,H etc.}
\begin{align*}
