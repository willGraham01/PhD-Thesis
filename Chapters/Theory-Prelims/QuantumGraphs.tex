...
Before continuing, we address a detail concerning how we formulate our quantum graph problems and the definition of the $M$-matrix. \tstk{notation! Want $\graph$ for period graph, and overhead hat for bigger periodic one?}
