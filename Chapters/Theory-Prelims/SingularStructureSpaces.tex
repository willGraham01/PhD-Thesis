...
Our definition of the space of functions possessing curls is motivated by this approach, and the definitions of \cite{cherednichenko2022operator, cherednichenko2022order}, although the latter works with a Floquet transform rather than a Gelfand transform (see section \ref{sec:TP-GelfandTransform}).
