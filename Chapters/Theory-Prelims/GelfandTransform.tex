...
The action of $\mathcal{A}$ on a function $u$ can be deduced from the ``sum" of actions of the $\mathcal{A}_{\qm}$ on $\gelfand u(\cdot,\qm)$,
...
\end{align}
and one can prove that the spectrum of $\mathcal{A}$ is formed from the union of the spectra of $\mathcal{A}_{\qm}$ over $\qm$ \tstk{ref for this? It's a standard result...}, 
\begin{align*}
