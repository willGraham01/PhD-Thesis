...
One can demonstrate (using density arguments) that $\gelfand$ can be extended to an isometry from $L^2\bracs{\reals^d}$ to $\L^2{\ddom}$-valued functions on $B$. \tstk{get refs for this?}.
