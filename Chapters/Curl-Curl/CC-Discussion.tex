...
This analysis (and definition of the corresponding operator) is currently an open problem in the context of singular structures, \tstk{although it was answered in the lebesgue case (Birman-Suslena?)}.
...
This being said, the definition of divergence free that is analysed in section \ref{sec:DivFreeCondition} does translate into the first order context
