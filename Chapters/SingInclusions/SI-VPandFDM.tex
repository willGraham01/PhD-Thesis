...
We can also illustrate the rate of convergence of the numerical scheme to the eigenvalues $\omega_{n,m}^2 = \bracs{n^2+m^2}\pi^2$.
...
Indeed, this is what we observe numerically for each $n,m$, as shown in figure \tstk{place several log errors onto one axis. Then accompany with the ``analytic solution vs best approximation" plots}
\begin{figure}[h]
	\centering
