...
\begin{prop} \label{prop:SI-GradZeroExtensionAndChar}
	...
	\begin{enumerate}[(i)]
		...
		\item Let $g\in\ltwo{\ddom}{\compMes}^2$ and $\widetilde{g}\in\ltwo{\ddom}{\ccompMes}$, where
	\begin{align*}
		g = \begin{cases} g_{\lambda_2} & x\in\ddom\setminus\graph, \\ g_{\ddmes} & x\in\graph, \end{cases}
		\qquad
		\widetilde{g} = \begin{cases} g_{\lambda_2} & x\in\ddom\setminus\graph, \\ g_{\ddmes} & x\in\graph\setminus\vertSet, \\ g_{\massMes} & x\in\vertSet. \end{cases}
	\end{align*}
	...
	\begin{align*}
		...
		\widetilde{g}\in\gradZero{\ddom}{\ccompMes}
		\quad\Leftrightarrow\quad &
