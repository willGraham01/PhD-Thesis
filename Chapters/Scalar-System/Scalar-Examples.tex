...
\end{align*}
\tstk{contextualise these plots! found the e'vec corresponding to $(M-B)u = 0$, and $u$ contains the dirchlet data for the eigenfunction --- then reconstructed function using the known form for the edge solutions.
\begin{figure}[h]
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.6]{CrossInPlane_EdgePlot-R-a1.pdf}
		\caption{\label{fig:CrossInPlane_EdgePlot-R-a1} The real part of the eigenfunction.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.6]{CrossInPlane_EdgePlot-I-a1.pdf}
		\caption{\label{fig:CrossInPlane_EdgePlot-I-a1} The imaginary part of the eigenfunction.}
	\end{subfigure}	
	\caption{\label{fig:CrossInPlane-EdgePlot-a1} Plots of the eigenfunction corresponding to the eigenvalue $\omega=0.63936$ for when $\alpha=1$, attained when $\qm=\bracs{\frac{\pi}{4},\frac{\pi}{4}}^\top$, overlaid onto the graph $\graph$.}
\end{figure}
\begin{figure}[h]
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.6]{CrossInPlane_EdgePlot-R-a4.pdf}
		\caption{\label{fig:CrossInPlane_EdgePlot-R-a4} The real part of the eigenfunction.}
	\end{subfigure}
	~
	\begin{subfigure}[t]{0.45\textwidth}
		\centering
		\includegraphics[scale=0.6]{CrossInPlane_EdgePlot-I-a4.pdf}
		\caption{\label{fig:CrossInPlane_EdgePlot-I-a4} The imaginary part of the eigenfunction.}
	\end{subfigure}	
	\caption{\label{fig:CrossInPlane-EdgePlot-a4} Plots of the eigenfunction corresponding to the eigenvalue $\omega=0.44812$ for when $\alpha=4$, attained when $\qm=\bracs{\frac{\pi}{4},\frac{\pi}{4}}^\top$, overlaid onto the graph $\graph$.}
\end{figure}
}
